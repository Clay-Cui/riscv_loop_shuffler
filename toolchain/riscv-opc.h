...
/* Permutation*/
#define MASK_PM_SET_INDEX	0xfffff
#define MASK_PM_UPDATE	0xffffffff
#define MASK_INDEX_UPDATE	0xfff07fff
#define MASK_RAND_WORD	0xfffff07f
#define MASK_RAND_BYTE	0xfffff07f
#define MASK_PM_ADD_TO_BASE 	0xfe00707f
#define MASK_PM_LBUP    0x707f
#define MASK_PM_SBP     0x707f
#define MASK_PM_LWP    0x707f
#define MASK_PM_SWP     0x707f
#define MASK_GFMUL		0xfe00707f
#define MASK_GFMULI		0x707f

#define MATCH_PM_SET_INDEX	0x3b
#define MATCH_PM_UPDATE	0x103b
#define MATCH_RAND_WORD	0x203b
#define MATCH_RAND_BYTE	0x303b
#define MATCH_PM_ADD_TO_BASE	0x403b
#define MATCH_INDEX_UPDATE	0x503b
#define MATCH_PM_LBUP       0x406b
#define MATCH_PM_SBP        0x77
#define MATCH_PM_LWP       0x206b
#define MATCH_PM_SWP        0x2077
#define MATCH_GFMUL		0x001b		
#define MATCH_GFMULI		0x101b
...
DECLARE_INSN(setindex,MATCH_PM_SET_INDEX,MASK_PM_SET_INDEX)
DECLARE_INSN(updateperm,MATCH_PM_UPDATE,MASK_PM_UPDATE)
DECLARE_INSN(updateindex,MATCH_INDEX_UPDATE,MASK_INDEX_UPDATE)
DECLARE_INSN(randw,MATCH_RAND_WORD,MASK_RAND_WORD)
DECLARE_INSN(randb,MATCH_RAND_BYTE,MASK_RAND_BYTE)

DECLARE_INSN(addtoba,MATCH_PM_ADD_TO_BASE,MASK_PM_ADD_TO_BASE)
DECLARE_INSN(lbup,MATCH_PM_LBUP,MASK_PM_LBUP)
DECLARE_INSN(sbp,MATCH_PM_SBP,MASK_PM_SBP)
DECLARE_INSN(lwp,MATCH_PM_LWP,MASK_PM_LWP)
DECLARE_INSN(swp,MATCH_PM_SWP,MASK_PM_SWP)
