...
{"hwlp.starti", 		"I", "di,b1",    	MATCH_HWLP_STARTI, 			MASK_HWLP_STARTI,match_opcode, 	0},
{"hwlp.endi",   		"I", "di,b1",    	MATCH_HWLP_ENDI,   			MASK_HWLP_ENDI,  match_opcode, 	0},
{"hwlp.counti", 		"I", "di,ji",    	MATCH_HWLP_COUNTI, 			MASK_HWLP_COUNTI,match_opcode, 	0},
{"hwlp.count",  		"I", "di,s",     	MATCH_HWLP_COUNT,  			MASK_HWLP_COUNT, match_opcode, 	0},

/* permutation related*/
{"setindex",	"I", "j", 		MATCH_PM_SET_INDEX,			MASK_PM_SET_INDEX,	match_opcode,	0},
{"update.perm",	"I", "",			MATCH_PM_UPDATE,			MASK_PM_UPDATE,	match_opcode,   0},
{"update.index",	"I", "s",			MATCH_INDEX_UPDATE,			MASK_INDEX_UPDATE,	match_opcode,   0},
{"randw", 	"I", "d",		MATCH_RAND_WORD,			MASK_RAND_WORD,	match_opcode,	0},
{"randb", 	"I", "d",		MATCH_RAND_BYTE,			MASK_RAND_BYTE,	match_opcode,	0},
{"addtoba",	"I", "d,s,t",		MATCH_PM_ADD_TO_BASE,			MASK_PM_ADD_TO_BASE,	match_opcode,	0},
{"gfmul",	"I", "d,s,t",		MATCH_GFMUL,				MASK_GFMUL,		match_opcode,	0},
{"gfmuli",	"I", "d,s,j",		MATCH_GFMULI,				MASK_GFMULI,		match_opcode,	0},
{"lbup",	"I", "d,o(s)",		MATCH_PM_LBUP,				MASK_PM_LBUP,		match_opcode,	0},
{"sbp",	"I", "t,q(s)",		MATCH_PM_SBP,				MASK_PM_SBP,		match_opcode,	0},
{"lwp",	"I", "d,o(s)",		MATCH_PM_LWP,				MASK_PM_LWP,		match_opcode,	0},
{"swp",	"I", "t,q(s)",		MATCH_PM_SWP,				MASK_PM_SWP,		match_opcode,	0},
